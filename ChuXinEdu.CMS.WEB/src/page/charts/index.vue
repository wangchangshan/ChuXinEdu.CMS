...
import { axios, dateHelper } from "@/utils/index";
    ...
    methods: {
        ...
        getTotalActualIncome() {
            axios({
                ...
                fn: result => {
                    ...
                    this.totalActualIncome.title =
                        "销课收入分布图 " + total.toFixed(2) + "元";
        ...
        getXiaoKeDistribution() {
            axios({
                type: "get",
                path:
                    "/api/statistics/coursedistribution?range=" +
                    this.monthRange,
                fn: result => {
