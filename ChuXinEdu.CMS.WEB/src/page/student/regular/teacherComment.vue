<template>
    ...
    <comment :time="'2019-01-11'" :id="1" :content="'test'"></comment>
    </div>-->
    <div class="table_container">
        ...
        >
            ...
            <el-table-column prop="courseDate" label="时间" align="center" width="120"></el-table-column>
            <el-table-column prop="content" label="课堂评语" align="left" min-width="200"></el-table-column>
            <el-table-column prop="teacherName" label="点评教师" align="center" width="100"></el-table-column>
            <el-table-column prop="operation" align="center" label="操作" fixed="right" width="130">
                <template slot-scope="scope">
                    ...
                    <el-button
                        ...
                        size="mini"
                        icon="el-icon-delete"
                        @click="removeComment(scope.row.commentId)"
                    ></el-button>
                </template>
            </el-table-column>
        </el-table>
        <div class="footer_container">
            <el-button v-noRepeatClick type="primary" size="small" @click="addComment()">
                <i class="fa fa-plus" aria-hidden="true"></i> 添加课堂评语
            </el-button>
            <el-button
                v-noRepeatClick
                type="primary"
            ...
            >
                <i class="fa fa-camera" aria-hidden="true"></i> 导出图片
            </el-button>
        </div>
        ...
        >
            <div class="form">
                <el-form
                    ref="comment"
                    :model="commentDialog.commentInfo"
                    :rules="commentDialog.commentInfoRules"
                    :label-width="commentDialog.formLabelWidth"
                    :label-position="commentDialog.labelPosition"
                    size="mini"
                ...
                >
                    <el-form-item prop="courseDate" label="时间">
                        <el-date-picker
                            v-model="commentDialog.commentInfo.courseDate"
                            type="date"
                            placeholder="选择日期"
                            :editable="false"
                            size="mini"
                    ...
                    <el-form-item prop="content" label="评语">
                        <el-input
                            ...
                            :rows="6"
                            placeholder="请输入教师评语"
                            v-model="commentDialog.commentInfo.content"
                        ></el-input>
                    </el-form-item>
...
<script>
import { dateHelper, LocalDB, axios } from "@/utils/index";
    ...
    methods: {
        ...
        addComment() {
            if (!this.curTeacherLoginCode) {
                let strUser = LocalDB.instance("USER_").getValue("BASEINFO")
                    .value;
            ...
            html2canvas(cloneDom, h2cOpts).then(canvas => {
                ...
                if (img.complete) {
                    ...
                    img.onload = () => {
                        ...
                        ctx.fillText(
                            this.studentName,
                            waterMarkOpts.linePositionX,
                            waterMarkOpts.firstLinePositionY
                        );
                        ctx.fillText(
                            "初心工作室",
                            waterMarkOpts.linePositionX,
                            waterMarkOpts.secondLinePositionY
                        );
                        ctx.fillText(
                            dateHelper.getDate(),
                            waterMarkOpts.linePositionX,
                            waterMarkOpts.thirdLinePositionY
                        );
                        //坐标系还原
                        //ctx.rotate(-waterMarkOpts.rotateAngle);
