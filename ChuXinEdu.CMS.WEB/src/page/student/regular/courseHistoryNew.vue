...
<div class="info_container">
    <div class="search_container">
        <el-form :inline="true" :model="searchField" class="demo-form-inline search-form">
            ...
            <el-form-item>
                <el-button type="primary" icon="el-icon-search" size="small" @click='searchCourseList()'>查询</el-button>
            </el-form-item>
...
export default {
    ...
    methods: {
        ...
        getHistoryCourseList({
            ...
            this.searchField.studentCode = this.studentCode;
            var data = {
            ...
            axios({
                type: 'get',
                path: '/api/student/gethistorycourselist',
                data: data,
                fn: result => {
